...
|------------|--------------|------------------|----------|
| **7** | ~1.22 km | ~50 hexagons | District-level analysis |
| **8** | ~461 m | ~350 hexagons | **Neighborhood analysis** ⭐ |
| **9** | ~174 m | ~2,500 hexagons | **Street-level precision** ⭐ |
...
### Processing Speed:
- **H3 assignment**: ~500K records/minute
- **Cyclical encoding**: ~1M records/minute  
